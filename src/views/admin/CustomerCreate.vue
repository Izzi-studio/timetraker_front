...
const { createCustomer, loadCompanyInfo } = adminStore
...
const formHandler = async () => {
    ...
    try {
        await createCustomer(route.params.id, form)

        router.push({ name: 'admin-company-customers' })
...
<template>
    <div class="container">
        <div class="breadcrumbs">
            ...
            <RouterLink :to="{name: 'admin-company-customers', params: { id: route.params.id }}">
                {{$t('customers')}}
            </RouterLink>
